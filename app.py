...
def upload_image():
    ...
    if operation_selection == 'gray':
        ...
        print('There is no image that has been selected')
    # Ends here
...
def image_skecth(decode_array_to_img):
    converted_gray_img = cv2.cvtColor(decode_array_to_img, cv2.COLORBGR2GRAY)
